            ...
            <form action="/register" method="post">
                <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
                    ...
                    <tr height="50">
                        ...
                        <td><label>
                            <input type="password" name="password" value="" class="l_pwd"/>
                        </label></td>
                    </tr>
                    <tr height="50">
                        <td align="right"><font color="#ff4e00">*</font>&nbsp;确认密码 &nbsp;</td>
                        <td><label>
                            <input type="password" name="password_1" value="" class="l_pwd"/>
                        </label></td>
                    </tr>
                    <tr height="50">
                        <td align="right"><font color="#ff4e00">*</font>&nbsp;邮箱 &nbsp;</td>
                        <td><label>
                            <input type="text" name="email" value="" class="l_email"/>
                        </label></td>
                    </tr>
                    <tr height="50">
                        <td align="right"><font color="#ff4e00">*</font>&nbsp;手机 &nbsp;</td>
                        <td><label>
                            <input type="text" name="mobile" value="" class="l_tel"/>
                        </label></td>
                    </tr>
                    <tr height="50">
...
<div class="btmbg">
    <div class="btm">
        ...
        <img src="images/b_1.gif" width="98" height="33"/><img src="images/b_2.gif" width="98" height="33"/>
        <img src="images/b_3.gif" width="98" height="33"/><img src="images/b_4.gif" width="98" height="33"/>
        <img src="images/b_5.gif" width="98" height="33"/><img src="images/b_6.gif" width="98" height="33"/>
    </div>
</div>
<!--End Footer End -->
